...
namespace MigraineTriggersTrackersAPP
{
    public partial class HomePage : System.Web.UI.Page
    {
        ...
        protected void AddSleepButton_Click(object sender, EventArgs e)
        {
            ...
            int hoursSelectedToInt = Convert.ToInt32(hoursSelected);

            hoursSelectedToInt = hoursSelectedToInt * 60;

            int minutesSelectedToInt = Convert.ToInt32(minutesSelected);

            int totalMinutes = hoursSelectedToInt + minutesSelectedToInt;
