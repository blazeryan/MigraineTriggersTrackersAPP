...
<body style="height: 38px">
    <form id="form1" style="height: 1000px" runat="server">
        <div class ="">
            <asp:Button ID="AddSymptomButton" runat="server" style="z-index: 1; left: 50px; top: 140px; position: absolute; width: 130px;" Text="ADD SYMPTOM" OnClick="AddSymptomButton_Click" Font-Bold="True" />
            <asp:Label ID="MInutesDropDownLabel" runat="server" Font-Bold="True" ForeColor="#003399" style="z-index: 4; left: 501px; top: 139px; position: absolute" Text="Minutes"></asp:Label>
        </div>
        <p>
            ...
            <asp:Label ID="PropertiesLabel" runat="server" Font-Bold="True" Font-Italic="True" ForeColor="White" style="z-index: 4; left: 508px; top: 26px; position: absolute; width: 103px; height: 29px;" Text="Properties"></asp:Label>
        ...
        <asp:Panel ID="TriggersPanel" runat="server" BackColor="#0066FF" style="z-index: 0; left: 241px; top: 17px; position: absolute; height: 288px; width: 177px" BorderColor="White" BorderStyle="Inset" BorderWidth="5px">
        </asp:Panel>
        ...
        <asp:Label ID="TriggersPanelLabel" runat="server" Font-Bold="True" ForeColor="White" style="z-index: 1; left: 1028px; top: 49px; position: absolute" Text="Triggers"></asp:Label>
        <asp:Panel ID="PropertiesPanel" runat="server" BackColor="#0066FF" style="z-index: 1; left: 451px; top: 17px; position: absolute; height: 288px; width: 177px" BorderColor="White" BorderStyle="Inset" BorderWidth="5px">
        </asp:Panel>
        <asp:DropDownList ID="HoursDropDownList" runat="server" AutoPostBack="True" style="z-index: 1; left: 501px; top: 111px; position: absolute; width: 105px;" OnSelectedIndexChanged="HoursDropDownList_SelectedIndexChanged1" DataSourceID="HoursDataSource" DataTextField="hours_number" DataValueField="hours_number">
        ...
        <asp:Label ID="QuantityDropDownLabel" runat="server" Font-Bold="True" ForeColor="#003399" style="z-index: 1; left: 501px; top: 242px; position: absolute" Text="Quantity"></asp:Label>
        <asp:DropDownList ID="MinutesDropDownList" runat="server" AutoPostBack="True" DataSourceID="MinutesDataSource" DataTextField="minutes_number" DataValueField="minutes_number" style="z-index: 1; left: 501px; top: 164px; position: absolute; width: 105px;">
        </asp:DropDownList>
        ...
        <asp:Panel ID="SymptomsPanel" runat="server" BackColor="#0066FF" BorderColor="White" BorderStyle="Inset" BorderWidth="5px" style="z-index: 0; left: 35px; top: 17px; position: absolute; height: 288px; width: 177px">
        </asp:Panel>
        ...
        <asp:Label ID="IntensityDropDownLabel" runat="server" Font-Bold="True" ForeColor="#003399" style="z-index: 1; left: 502px; top: 190px; position: absolute; right: 664px;" Text="Intensity"></asp:Label>
        ...
        <asp:Button ID="RemoveLastButton" runat="server" OnClick="RemoveLastButton_Click" style="z-index: 1; left: 172px; top: 581px; position: absolute" Text="Remove Last" Font-Bold="True" />
        ...
        <asp:DropDownList ID="DrinksDropDownList" runat="server" AutoPostBack="True" style="z-index: 1; left: 1032px; top: 210px; position: absolute; width: 130px;" DataSourceID="DrinksDataSource" DataTextField="drink_name" DataValueField="drink_name">
        ...
        <asp:DropDownList ID="QuantityDropDownList" runat="server" style="z-index: 1; left: 502px; top: 266px; position: absolute; width: 105px;" AutoPostBack="True" OnSelectedIndexChanged="QuantityDropDownList_SelectedIndexChanged1" DataSourceID="QuantityDataSource" DataTextField="quantity_number" DataValueField="quantity_number">
        ...
        <asp:SqlDataSource ID="QuantityDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:MigraineTriggersTrackersDBConnectionString %>" SelectCommand="SELECT [quantity_number] FROM [quantity]"></asp:SqlDataSource>
            ...
            <asp:TextBox ID="NotesTextBox" runat="server" style="z-index: 1; left: 447px; top: 342px; position: absolute; width: 544px; height: 229px;" OnTextChanged="NotesTextBox_TextChanged"></asp:TextBox>
        <asp:Button ID="HistoryButton" runat="server" style="z-index: 1; left: 740px; top: 285px; position: absolute; width: 252px;" Text="History" Font-Bold="True" BackColor="#FFCC66" />
        <asp:Calendar ID="Calendar1" runat="server" style="z-index: 1; left: 740px; top: 81px; position: absolute; height: 195px; width: 252px; margin-bottom: 0px;" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#663399" OnSelectionChanged="Calendar1_SelectionChanged" ShowGridLines="True" Width="220px">
        ...
        <asp:Button ID="SubmitButton" runat="server" style="z-index: 1; left: 740px; top: 581px; position: absolute; width: 252px;" Text="Submit" Font-Bold="True" BackColor="#0066FF" OnClick="SubmitButton_Click" />
        <asp:Button ID="AddSleepButton" runat="server" style="z-index: 1; left: 1028px; top: 114px; position: absolute; width: 130px;" Text="ADD SLEEP" OnClick="AddSleepButton_Click" Font-Bold="True" />
        ...
        <asp:Button ID="AddDrinksButton" runat="server" Text="ADD DRINKS" Font-Bold="True" style="z-index: 1; left: 1036px; top: 247px; position: absolute; width: 130px;" OnClick="AddDrinksButton_Click" />
        <asp:Label ID="NotesLabel" runat="server" Font-Bold="True" style="z-index: 1; left: 450px; top: 313px; position: absolute" Text="Notes" ForeColor="#003399"></asp:Label>
        ...
        <asp:DropDownList ID="SleepDropDownList" runat="server" style="z-index: 1; left: 1020px; top: 80px; position: absolute; width: 130px;" DataSourceID="SleepDataSource" DataTextField="sleep_name" DataValueField="sleep_name" AutoPostBack="True" OnSelectedIndexChanged="SleepDropDownList_SelectedIndexChanged1">
            <asp:ListItem>Sleep</asp:ListItem>
        </asp:DropDownList>
        <asp:Label ID="HoursLabel" runat="server" Font-Bold="True" style="z-index: 1; left: 503px; top: 87px; position: absolute; width: 105px" Text="Hours" ForeColor="#003399"></asp:Label>
        ...
        <asp:GridView ID="DetailsGridView" runat="server" AutoGenerateColumns="False" DataSourceID="GridViewDataSource" OnSelectedIndexChanged="DetailsGridView_SelectedIndexChanged" style="z-index: 1; left: 57px; top: 636px; position: absolute; height: 735px; width: 931px; margin-right: 178px">
            <Columns>
