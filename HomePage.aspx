...
<body style="height: 38px">
    <form id="form1" runat="server">
        ...
        <asp:DropDownList ID="SymptomsDropDownList" runat="server" AutoPostBack="True" OnSelectedIndexChanged="SymptomsDropdownList_SelectedIndexChanged" style="z-index: 1; left: 50px; top: 80px; position: absolute; width: 105px; right: 1392px;">
            <asp:ListItem>Symptoms</asp:ListItem>
        </asp:DropDownList>
        <asp:DropDownList ID="TimeDropDownList" runat="server" AutoPostBack="True" style="z-index: 1; left: 237px; top: 80px; position: absolute; width: 91px;" OnSelectedIndexChanged="TimeDropDownList_SelectedIndexChanged1">
            <asp:ListItem>Time</asp:ListItem>
        </asp:DropDownList>
        <asp:DropDownList ID="IntensityDropDownList" runat="server" AutoPostBack="True" style="z-index: 1; left: 237px; top: 125px; position: absolute" OnSelectedIndexChanged="IntensityDropDownList_SelectedIndexChanged1">
            <asp:ListItem Value="Intensity"></asp:ListItem>
        </asp:DropDownList>
        <asp:DropDownList ID="DrinksDropDownList" runat="server" AutoPostBack="True" style="z-index: 1; left: 420px; top: 210px; position: absolute; width: 105px;">
            <asp:ListItem>Drinks</asp:ListItem>
        </asp:DropDownList>
        <asp:DropDownList ID="QuantityDropDownList" runat="server" style="z-index: 1; left: 238px; top: 170px; position: absolute; width: 91px;" AutoPostBack="True" OnSelectedIndexChanged="QuantityDropDownList_SelectedIndexChanged1">
        ...
        <asp:Button ID="AddFoodsButton" runat="server" style="z-index: 1; left: 50px; top: 255px; position: absolute; width: 130px" Text="ADD FOODS" Font-Bold="True" />
        <asp:Button ID="AddDrinksButton" runat="server" Text="ADD DRINKS" Font-Bold="True" style="z-index: 1; left: 394px; top: 255px; position: absolute; width: 130px;" />
        ...
        <asp:DropDownList ID="SleepDropDownList" runat="server" style="z-index: 1; left: 420px; top: 80px; position: absolute; width: 105px;">
